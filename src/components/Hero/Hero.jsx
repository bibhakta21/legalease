...
>
  Get Instant <span className="text-primary text-4xl lg:text-5xl">Legal Solutions</span>
</motion.h1>
<motion.p
  ...
  animate="visible"
>
  Chat with our AI-powered legal assistant to resolve your queries and 
  understand your rights in just a few clicks.
</motion.p>
<motion.div
...
>
<Link to="/chatbot">
  <button className="primary-btn">Ask Your Question</button>
  </Link>
